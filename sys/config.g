...
if !exists(global.KlickyXpos)
  global KlickyXpos=37.3                                ; X axis klicky dock position
...
M150 E1 R255 U255 B255 P160	S24							; set strip 1 to white by default - 24 leds total

M950 E2 C"124.rgbled" T1								; create strip 2 on pin 124.rgbled and set it to RGB
M150 E2 R255 U0 B255 P128 S3 F0 						; set to purple - 3 leds total
